...
public class GoToPositionTest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            GoToPosition.goToPosition(XPOSITION_1, YPOSITION_1, HEADING_1, STOP, odometry, leftFront, leftBack, rightFront, rightBack, telemetry, .8);
            GoToPosition.goToPosition(XPOSITION_2, YPOSITION_2, HEADING_2, STOP, odometry, leftFront, leftBack, rightFront, rightBack, telemetry, .8);
            GoToPosition.goToPosition(XPOSITION_3, YPOSITION_3, HEADING_3, STOP, odometry, leftFront, leftBack, rightFront, rightBack, telemetry, .8);
